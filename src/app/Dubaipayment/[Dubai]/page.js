...
export default function Home() {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(
          `https://world-diplomats-backend.onrender.com/api/secondenames?filters[id][$eq]=${id}`
        );
  ...
  const handleCreateInvoice = async (amount) => {
    ...
    let disnew = 'Basic';
    if (amount === 551) disnew = 'Shepandum Experience';
    if (amount === 670) disnew = 'Zagatiya Experience';
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              <PlanCard
                ...
                onPay={() => seo(389)}
                onInvoice={() => handleCreateInvoice(389)}
              ...
              <PlanCard
                ...
                setActiveCard={setActiveCard}
                onPay={() => seo(551)}
                onInvoice={() => handleCreateInvoice(551)}
                loader={invoiceLoader}
              />
              ...
              <PlanCard
                ...
                setActiveCard={setActiveCard}
                onPay={() => seo(670)}
                onInvoice={() => handleCreateInvoice(670)}
                loader={invoiceLoader}
              />
            </div>
          </div>
