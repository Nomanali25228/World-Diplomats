...
const Whatsapp = () => {
  ...
  className="fixed bottom-20 right-5 z-50 flex items-center justify-center bg-green-500 text-white w-14 h-14 rounded-full shadow-lg hover:bg-green-600 transition-transform transform hover:scale-105 "
