...
const EligibilityCriteria = () => {
  ...
  return (
    <div className="w-full bg-[#F1F2F4] py-16 px-4">
      <div className="text-center mb-10">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#2C3E50]" data-aos="fade-up">
          Eligibility Criteria
        </h2>

        <p className="text-gray-500 mt-2 mb-2" data-aos="fade-up" data-aos-delay="100">
      ...
      <div className="relative flex flex-col md:flex-row items-center justify-between gap-12 max-w-6xl mx-auto">
        ...
        {items.map((item, index) => (
          <div
            ...
            data-aos="fade-up"
            data-aos-delay={index * 150 + 100} // staggered animation
          >
