...
export default function Home() {
  ...
  const handleCreateInvoice = async (amount) => {
    ...
    let disnew = 'Basic';
    if (amount === 1191) disnew = 'Shepandum Experience';
    if (amount === 1628) disnew = 'Zagatiya Experience';
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              <PlanCard
                ...
                onPay={() => seo(859)}
                onInvoice={() => handleCreateInvoice(859)}
              ...
              <PlanCard
                ...
                setActiveCard={setActiveCard}
                onPay={() => seo(1191)}
                onInvoice={() => handleCreateInvoice(1191)}
                loader={invoiceLoader}
              />
              ...
              <PlanCard
                ...
                setActiveCard={setActiveCard}
                onPay={() => seo(1628)}
                onInvoice={() => handleCreateInvoice(1628)}
                loader={invoiceLoader}
              />
            </div>
          </div>
