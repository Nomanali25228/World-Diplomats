...
export default function Home() {
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(
          `https://world-diplomats-backend.onrender.com/api/fivenames?filters[id][$eq]=${id}`
        );
  ...
  const handleCreateInvoice = async (amount) => {
    ...
    let disnew = 'Basic';
    if (amount === 879) disnew = 'Shepandum Experience';
    if (amount === 1050) disnew = 'Zagatiya Experience';
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              <PlanCard
                ...
                onPay={() => seo(499)}
                onInvoice={() => handleCreateInvoice(499)}
              ...
              <PlanCard
                ...
                setActiveCard={setActiveCard}
                onPay={() => seo(879)}
                onInvoice={() => handleCreateInvoice(879)}
                loader={invoiceLoader}
              />
              ...
              <PlanCard
                ...
                setActiveCard={setActiveCard}
                onPay={() => seo(1050)}
                onInvoice={() => handleCreateInvoice(1050)}
                loader={invoiceLoader}
              />
            </div>
          </div>
