...
export async function POST(request) {
    try {
        ...
        let country = 'UK';
        let CityTour = '';
        if (dest.includes('London')) { desname = 'London, UK'; country = 'London, UK'; CityTour = 'London city tour'; }
        else if (dest.includes('Dubai')) { desname = 'Dubai, UAE'; country = 'Dubai, UAE'; CityTour = 'Desert Safari'; }
        else if (dest.includes('Istanbul')) { desname = 'Istanbul, Türkiye'; country = 'Istanbul, Türkiye'; CityTour = 'Istanbul City Tour'; }
        ...
        const buttonLink = isDelegation ? 'https://wa.me/+447490344639' : `https://www.worlddiplomats.org/Londonpayment/1?userid=${id}`;
                                ...
                                <tr>
                                    ...
                                    <td align="center" style="font-size:10px;">
                                        <a href="https://www.tiktok.com/@worlddiplomats" target="_blank"
                                            style="color:#0a3b6d;text-decoration:none; display: inline-block;">
