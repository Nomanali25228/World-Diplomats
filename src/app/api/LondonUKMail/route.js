...
export async function POST(request) {
    try {
        ...
        const dest = (destination || 'London, UK').trim();
        let desname = dest;
        let country = 'UK';
        let CityTour = '';
        if (dest.includes('London')) { desname = 'London, UK'; country = 'UK'; CityTour = 'London city tour'; }
                                        ...
                                        <table cellpadding="0" cellspacing="0" align="center">
                                            <tr>
                                                <td align="center" bgcolor="#0b67c2" style="border-radius:22px;">
                                                    <a href="https://www.worlddiplomats.org/Londonpayment/1?userid=${id}" target="_blank" style="
                                        ...
                                        <table width="100%" height="330" cellpadding="12" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center" valign="bottom">
                                                    <a href="https://www.worlddiplomats.org/Londonpayment/1?userid=${id}" target="_blank" style="text-decoration:none;">
                  ...
                  color:#fff;padding:12px 24px;border-radius:14px;font-weight:600;">
                                    ...
                                    <td width="33%" valign="top" style="padding:4px;">
                                        <table width="100%" height="330" cellpadding="12" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center" valign="bottom">
                                                    <a href="https://www.worlddiplomats.org/Londonpayment/2?userid=${id}" target="_blank" style="text-decoration:none;">
                                                        <div style="background:linear-gradient(90deg,#8c1537,#0b67c2);
                  color:#fff;padding:12px 24px;border-radius:14px;font-weight:600;">
                                                            CHOOSE PLAN
                                                        </div>
                                    ...
                                    <td width="33%" valign="top" style="padding:4px;">
                                        <table width="100%" height="330" cellpadding="12" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center" valign="bottom">
                                                    <a href="https://www.worlddiplomats.org/Londonpayment/3?userid=${id}" target="_blank" style="text-decoration:none;">
                                                        <div style="background:linear-gradient(90deg,#8c1537,#0b67c2);
                  color:#fff;padding:12px 24px;border-radius:14px;font-weight:600;">
                                                            CHOOSE PLAN
                                                        </div>
...
#E3155A 92.3076% 100%);
    ...
    <!-- END MAIN CONTAINER -->
        ...
        console.error('LondonUKMail error', err);
