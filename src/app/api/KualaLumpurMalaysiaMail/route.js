...
export async function POST(request) {
    try {
        ...
        const dest = (destination || 'Kuala Lumpur, Malaysia').trim();
        let desname = dest;
        let country = 'Malaysia';
        let CityTour = '';
        if (dest.includes('Kuala Lumpur')) { desname = 'Kuala Lumpur, Malaysia'; country = 'Kuala Lumpur, Malaysia'; CityTour = 'Batu Caves'; }
        ...
        const buttonLink = isDelegation ? 'https://wa.me/+447490344639' : `https://www.worlddiplomats.org/Malaysiapayment/1?userid=${id}`;
