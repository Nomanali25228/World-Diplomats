...
export async function POST(request) {
  try {
        ...
        let CityTour = '';
        if (dest === 'Kuala Lumpur, Malaysia') { desname = 'Kuala Lumpur, Malaysia'; country = 'Malaysia'; CityTour = 'Batu Caves'; }
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="text-align:center; padding: 20px 0;">
                    ...
                    <tr>
                        <td style="color:#0a3b6d;font-size:14px;font-weight:400;padding-bottom:18px;">
                            at World Diplomats MUN and await, in <br /> anticipation, to host you at Turkey.
                        </td>
                    </tr>
                                ${closingMessage}
                    <!-- LINKS ROW -->
