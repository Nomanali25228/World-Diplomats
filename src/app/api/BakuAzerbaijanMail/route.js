...
export async function POST(request) {
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'World Diplomats — Registration Received (Baku, Azerbaijan)',
      html: `<p>Hi ${name || 'Participant'},</p>
             <p>Thank you for registering for World Diplomats — Baku, Azerbaijan. We have received your registration.</p>
